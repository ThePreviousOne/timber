...
public final class Timber {
    ...
    /** Log a "Loud Assertion" with a throwable and optional arguments */
    public static void loud(Throwable t, @NonNls String format, Object... args) {
        TREE_OF_SOULS.loud(t, format, args);
    }

    /** Log a "Loud Assertion" with optional arguments */
    public static void loud(@NonNls String format, Object... args) {
        TREE_OF_SOULS.loud(format, args);
    }

    /** Log a "Loud Assertion" */
    public static void loud(String message) {
        TREE_OF_SOULS.loud(message);
    }

    /** Log a "Loud Assertion" exception */
    public static void loud(Throwable t) {
        TREE_OF_SOULS.loud(t);
    }
    ...
    */
    ...
    private static final Tree TREE_OF_SOULS = new Tree() {
        ...
        @Override public void loud(Throwable t, String format, Object... args){
            Tree[] forest = forestAsArray;
            for (Tree tree: forest) {
                tree.loud(t, format, args);
            }
        }

        @Override public void loud(String format, Object... args) {
            Tree[] forest = forestAsArray;
            for (Tree tree: forest) {
                tree.loud(format, args);
            }
        }

        @Override public void loud(String message){
            Tree[] forest = forestAsArray;
            for (Tree tree: forest) {
                tree.loud(message);
            }
        ...
        @Override public void loud(Throwable t){
            Tree[] forest = forestAsArray;
            for (Tree tree: forest) {
                tree.loud(t);
            }
    ...
    public static abstract class Tree {
        ...
        /** Log a "Loud Assertion" with a throwable and optional arguments */
        public void loud(Throwable throwable, String format, Object... args) {
            prepareLog(Log.ASSERT, throwable,
                      "==============================================\n"
                    + "==============================================\n"
                    +        format
                  + "\n==============================================\n"
        ...
        /** Log a "Loud Assertion" with optional arguments */
        public void loud(String format, Object... args) {
        ...
        */
        ...
        private void prepareLog(int priority, Throwable t, String message, Object... args) {
            ...
            if (message == null) {
                if (t == null) {
                    message = "null"; // Ensures Log will always print
                } else {
